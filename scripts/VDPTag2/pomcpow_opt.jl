...
@show start_mean = [110.0, 30.0, 30.0, 5.0, 100.0]
@show start_cov = diagm([100.0^2, 20.0^2, 20.0^2, 10.0^2, 50.0^2])
...
try
  for i in 1:max_iters
      ...
      if save_data
        fname_csv = joinpath(@__DIR__, "../data", "VDP_pomcpow_opt"*"_"*datestring*".csv")
